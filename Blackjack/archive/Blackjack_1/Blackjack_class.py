...
################################################################################
        ...
        for player in self.players:
            ...
            if player.score < 21:
                ...
                if choice == 1:
                    ...
                    BlackJack.getScore(player)
                    if player.score < 21:
                        BlackJack.contTurn(player, self.dealer, self.shoe)
                    else:
    ...
    def playAgain(self):
        ...
        for player in self.players:
            ...
            elif player.chipcount < BlackJack.minbet:
                print("{} has insufficient chips to place a bet. Please leave the table.".format(player.name))
                self.players.remove(player)
...
################################################################################
    ...
    def contTurn(player, dealer, shoe):
        os.system('clear')
        BlackJack.printHand(dealer, 1)
